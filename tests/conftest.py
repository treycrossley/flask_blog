...
def forms(app, db):
    ...
    return {'LoginForm': LoginForm, 'PostForm': PostForm, 'SearchForm': SearchForm, 
            'NamerForm': NamerForm,'PasswordForm': PasswordForm, 'UserForm': UserForm}
...
def authenticated_admin(client, db):
    ...
    admin_user = Users(username='admin_user', name='Admin User', email='admin@example.com', is_admin=True)
